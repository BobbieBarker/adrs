# Elixir Resilience / External Services - ADRs

ADRs covering calls to external services under failure: upstream rate limits, shared backpressure, and coordinated recovery.
